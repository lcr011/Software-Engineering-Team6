...
public class SplashScreen {
	...
	private void initialize() {
		...
		frame.setBounds((int)(.25f * Toolkit.getDefaultToolkit().getScreenSize().width), (int)(.25f * Toolkit.getDefaultToolkit().getScreenSize().height), (int)(.5f * Toolkit.getDefaultToolkit().getScreenSize().width), (int)(.5f * Toolkit.getDefaultToolkit().getScreenSize().height));
